...
**OZ Connect** — tên của cầu nối đa kênh này — được phát hành theo giấy phép **MIT**: ai cũng dùng được, sửa được, bán lại được. Hiện có **bốn kênh: Zalo, Telegram, Messenger và Viber** (đã kiểm thử, 74 test tự động). Một cầu, mọi kênh chạm khách.
...
- **Người biết code**: góp thêm kênh mới cho OZ Connect (Zalo OA, WhatsApp, và xa hơn), sửa lỗi, viết test. Repo mở, mời vào.
...
Đúng tinh thần chúng tôi làm từ đầu: OZ Connect mới ở bản đầu. Zalo, Telegram và Messenger đã chạy và có kiểm thử thật, tự tạo bot được miễn phí. Viber cũng đã chạy và có kiểm thử — nhưng có hai điều phải nói trước khi ai đó chọn kênh này: từ 05/02/2024 Viber chỉ cấp bot mới theo **điều khoản thương mại** (không còn tự tạo miễn phí như ba kênh kia), và tài liệu Viber **không công bố cơ chế xác thực webhook nào** — khác Zalo/Telegram/Messenger đều có. Chúng tôi ghi rõ cả hai giới hạn này trong code, không giấu.

Cầu này cũng chỉ nối tới **Zalo Bot Creator**, chưa nối Zalo OA — chúng tôi đã nói rõ ranh giới đó.
